...
Recent Files Exclusions is a tiny app that provides a way to exclude a folder and all its files and subfolders from the Windows Recent Files list (the lower pane in Explorer's default view).
